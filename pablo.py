...
# Screen width and height variables intialized
SCREEN_WIDTH = 800
SCREEN_HEIGHT = int(SCREEN_WIDTH*0.8)  # height will be 80% of the screen with

# game screen box delcared
screen = pygame.display.set_mode((SCREEN_WIDTH, SCREEN_HEIGHT))

# Giving gamebox name
pygame.display.set_caption('Agent Pablo')
# Icon change
icon = pygame.image.load('pngegg (2).png')
pygame.display.set_icon(icon)

# set framerate
clock = pygame.time.Clock()
FPS = 60  # frame rate 60 frames per sec
...
# Definiting player action variable
moving_left = False
moving_right = False
shoot = False
grenade = False
...
pygame.mixer.music.load('audio/Pablo.mp3')
pygame.mixer.music.set_volume(60)
pygame.mixer.music.play(-1, 0.0, 5000)
jump_fx = pygame.mixer.Sound('audio/jump.wav')
jump_fx.set_volume(30)
shot_fx = pygame.mixer.Sound('audio/shot.wav')
shot_fx.set_volume(15)
grenade_fx = pygame.mixer.Sound('audio/grenade.wav')
# grenade_fx.set_volume(90)
...
pabloimg = pygame.image.load('pngegg.png')
...
mountain_image = pygame.image.load(
    'img/Background/Screenshot (86).png').convert_alpha()
...
def draw_bg():
    ...
    for x in range(5):
        ...
        screen.blit(mountain_image, ((x * width) - bg_scroll * 0.6,
                    SCREEN_HEIGHT - mountain_image.get_height() - 300))
        screen.blit(pine1_image, ((x * width) - bg_scroll * 0.7,
                    SCREEN_HEIGHT - pine1_image.get_height() - 150))
        screen.blit(pine2_image, ((x * width) - bg_scroll * 0.8,
                    SCREEN_HEIGHT - pine2_image.get_height()))
...
death_fade = ScreenFade(2, SHADOW, 4)


# create buttons
start_button = button.Button(
    SCREEN_WIDTH // 2 - 400, SCREEN_HEIGHT // 2 - 15, start_img, 1)
exit_button = button.Button(
    SCREEN_WIDTH // 2 - (- 175), SCREEN_HEIGHT // 2 - 15, exit_img, 1)
